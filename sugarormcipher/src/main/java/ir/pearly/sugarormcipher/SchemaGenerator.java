...
import ir.pearly.sugarormcipher.dsl.Column;
import ir.pearly.sugarormcipher.dsl.MultiUnique;
import ir.pearly.sugarormcipher.dsl.NotNull;
import ir.pearly.sugarormcipher.dsl.Unique;
import ir.pearly.sugarormcipher.util.MigrationFileParser;
import ir.pearly.sugarormcipher.util.NamingHelper;
import ir.pearly.sugarormcipher.util.NumberComparator;
import ir.pearly.sugarormcipher.util.QueryBuilder;
import ir.pearly.sugarormcipher.util.ReflectionUtil;

import static ir.pearly.sugarormcipher.util.ReflectionUtil.getDomainClasses;
...
public class SchemaGenerator {
    ...
    public static final String SUGAR = "alavi.AlaviSugarCipher";
...
//                }
        ...
        for (String command : alterCommands) {
            Log.i("alavi.AlaviSugarCipher", command);
