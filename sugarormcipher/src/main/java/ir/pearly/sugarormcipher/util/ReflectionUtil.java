...
import ir.pearly.sugarormcipher.SugarRecord;
import ir.pearly.sugarormcipher.dsl.Ignore;
import ir.pearly.sugarormcipher.dsl.Table;
import ir.pearly.sugarormcipher.util.NamingHelper;
import ir.pearly.sugarormcipher.util.SugarConfig;

public class ReflectionUtil {

    public static List<Field> getTableFields(Class table) {
        List<Field> fieldList = ir.pearly.sugarormcipher.util.SugarConfig.getFields(table);
        if (fieldList != null) return fieldList;

        Log.d("alavi.AlaviSugarCipher", "Fetching properties");
    ...
    public static void addFieldValueToColumn(ContentValues values, Field column, Object object,
        ...
        try {
            String columnName = ir.pearly.sugarormcipher.util.NamingHelper.toSQLName(column);
            ...
            Log.e("alavi.AlaviSugarCipher", e.getMessage());
        }
    }
        ...
        try {
            ...
            if (colName.equalsIgnoreCase("id")) {
                ...
                try {
                    ...
                    Log.e("alavi.AlaviSugarCipher", "Enum cannot be read from Sqlite3 database. Please check the type of field " + field.getName());
                }
            } else
                Log.e("alavi.AlaviSugarCipher", "Class cannot be read from Sqlite3 database. Please check the type of field " + field.getName() + "(" + field.getType().getName() + ")");
    ...
    private static Class getDomainClass(String className, Context context) {
        ...
        try {
            ...
            Log.e("alavi.AlaviSugarCipher", error);
        }
        ...
        if ((discoveredClass != null) &&
            ...
            Log.i("alavi.AlaviSugarCipher", "domain class : " + discoveredClass.getSimpleName());
